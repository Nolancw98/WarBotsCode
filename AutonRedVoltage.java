 ...
 */
@Autonomous(name = "AutonRedVoltage v1.0", group = "Cool")
public class AutonRedVoltage extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        //voltageSensor = hardwareMap..get("Motor Controller 1");
    ...
    public void launcher(double speed, double timeoutS) throws InterruptedException
    {
        ...
        if(opModeIsActive()) {
            ...
            if (voltage > 13.5)
            {
                robot.motorLauncherLeft.setPower(.8);
                robot.motorLauncherRight.setPower(.8);
                telemetry.addLine(String.valueOf(voltage));
            }
            else if (voltage < 13.5 && voltage > 12.7)
            {
                robot.motorLauncherLeft.setPower(.9);
                robot.motorLauncherRight.setPower(.9);
                telemetry.addLine(String.valueOf(voltage));

            }
            else if (voltage < 12.7 && voltage > 12)
            {
